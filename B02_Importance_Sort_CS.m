...
aa=load([root_dataRead,'\mat_norm',num2str(idx_norm),'\Img_FS_Lasso_all_delta_Loop',num2str(num),'.mat']);
B1=aa.B1;
FitInfo = aa.FitInfo;
RE = aa.RE;
...
save([root_dataSave, '\Rank_CS_NSelect',num2str(NumSelect),'_norm',num2str(idx_norm),'.mat'],...
